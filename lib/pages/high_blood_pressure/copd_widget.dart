...
import 'copd_model.dart';
export 'copd_model.dart';
import 'package:http/http.dart' as http;

class COPDWidget extends StatefulWidget {
  const COPDWidget({super.key});

  static String routeName = 'COPD';
  static String routePath = '/COPD';

  @override
  State<COPDWidget> createState() => _COPDWidgetState();
}

class _COPDWidgetState extends State<COPDWidget> with TickerProviderStateMixin {
  late COPDModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => COPDModel());
    _loadLoginData();
    loadProvinces();
