...
import 'hyperlipidemia_model.dart';
export 'hyperlipidemia_model.dart';
import 'package:http/http.dart' as http;

class HyperlipidemiaWidget extends StatefulWidget {
  const HyperlipidemiaWidget({super.key});

  static String routeName = 'Hyperlipidemia';
  static String routePath = '/Hyperlipidemia';

  @override
  State<HyperlipidemiaWidget> createState() => _HyperlipidemiaWidgetState();
}

class _HyperlipidemiaWidgetState extends State<HyperlipidemiaWidget> with TickerProviderStateMixin {
  late HyperlipidemiaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HyperlipidemiaModel());
    _loadLoginData();
    loadProvinces();
