...
class HighBloodPressureWidget extends StatefulWidget {
  const HighBloodPressureWidget({super.key, this.cd_code});

  static String routeName = 'High_Blood_Pressure';
  static String routePath = '/highBloodPressure';
  final String? cd_code;

  @override
  State<HighBloodPressureWidget> createState() => _HighBloodPressureWidgetState();
}

class _HighBloodPressureWidgetState extends State<HighBloodPressureWidget> with TickerProviderStateMixin {
