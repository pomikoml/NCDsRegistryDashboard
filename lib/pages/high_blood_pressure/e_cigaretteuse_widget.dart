...
class E_CigaretteUseWidget extends StatefulWidget {
  const E_CigaretteUseWidget({super.key});

  static String routeName = 'E_CigaretteUse';
  static String routePath = '/E_CigaretteUse';

  @override
  State<E_CigaretteUseWidget> createState() => _E_CigaretteUseWidgetState();
}

class _E_CigaretteUseWidgetState extends State<E_CigaretteUseWidget> with TickerProviderStateMixin {
                                                                ...
                                                                children: [
                                                                  Row(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Text(
                                                                        'กราฟแสดงผู้ป่วยบุหรี่ไฟฟ้าทั้งหมด',
                                                                        style: FlutterFlowTheme.of(
                                                                          context,
                                                                        ).titleSmall.override(
                                                                              fontFamily: 'IBM Plex Sans Thai Looped',
