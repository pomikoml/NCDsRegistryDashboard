...
class HeartDiseaseWidget extends StatefulWidget {
  const HeartDiseaseWidget({super.key});

  static String routeName = 'HeartDisease';
  static String routePath = '/HeartDisease';

  @override
  State<HeartDiseaseWidget> createState() => _HeartDiseaseWidgetState();
}

class _HeartDiseaseWidgetState extends State<HeartDiseaseWidget> with TickerProviderStateMixin {
                                                                ...
                                                                children: [
                                                                  Row(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Text(
                                                                        'กราฟแสดงผู้ป่วยโรคหัวใจทั้งหมด',
                                                                        style: FlutterFlowTheme.of(
                                                                          context,
                                                                        ).titleSmall.override(
                                                                              fontFamily: 'IBM Plex Sans Thai Looped',
