...
// import 'package:n_c_ds_registry_dashboard/custom_code/widgets/blood_summary_province.dart';
...
import 'chronickidneydisease_model.dart';
export 'chronickidneydisease_model.dart';
import 'package:http/http.dart' as http;

class ChronicKidneyDiseaseWidget extends StatefulWidget {
  const ChronicKidneyDiseaseWidget({super.key});

  static String routeName = 'ChronicKidneyDisease';
  static String routePath = '/ChronicKidneyDisease';

  @override
  State<ChronicKidneyDiseaseWidget> createState() => _ChronicKidneyDiseaseWidgetState();
}

class _ChronicKidneyDiseaseWidgetState extends State<ChronicKidneyDiseaseWidget> with TickerProviderStateMixin {
  late ChronicKidneyDiseaseModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ChronicKidneyDiseaseModel());
    _loadLoginData();
    loadProvinces();
  ...
  //   final list = await getFilteredHospitalNames();
  //   setState(() {
  //     HospitalOptions = [
  //       'ทั้งหมด',
  //       '2',
  ...
  Future<void> fetchHighBloodPressureByAge({
    ...
    if (response.statusCode == 200) {
      ...
      setState(() {
        ...
        // เพิ่ม debug log
        debugPrint('[DEBUG] age0_4: $age0_4');
        debugPrint('[DEBUG] age5_11: $age5_11');
        debugPrint('[DEBUG] age12_17: $age12_17');
        debugPrint('[DEBUG] age18_59: $age18_59');
        debugPrint('[DEBUG] age60plus: $age60plus');
        debugPrint('[DEBUG] totalage: $totalage');
      });
    } else {
                                                ...
                                                children: [
                                                  ...
                                                  Padding(
                                                    ...
                                                    child:
                                                        ...
                                                        //   ),
                                                        // ),
                                                        // ใน build method ส่วนของปุ่ม ประมวลผล
                                                        GestureDetector(
                                                      onTapDown: (details) {
                                                        // เปลี่ยนสีเมื่อกดลง
                                                        setState(() {
