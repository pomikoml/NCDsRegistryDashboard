...
import 'obesity_model.dart';
export 'obesity_model.dart';
import 'package:http/http.dart' as http;

class ObesityWidget extends StatefulWidget {
  const ObesityWidget({super.key});

  static String routeName = 'Obesity';
  static String routePath = '/Obesity';

  @override
  State<ObesityWidget> createState() => _ObesityWidgetState();
}

class _ObesityWidgetState extends State<ObesityWidget> with TickerProviderStateMixin {
  late ObesityModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ObesityModel());
    _loadLoginData();
    loadProvinces();
