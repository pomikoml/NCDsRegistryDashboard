                                                  ...
                                                  children: [
                                                    ...
                                                    Obx(() {
                                                      if (getX.apiToken.value.isEmpty) {
                                                        ...
                                                        return Expanded(flex: 0, child: buildPagination(getX));
                                                      }
                                                    }),
...
//           onPressed: currentPage > 1 ? () => getX.fetchNCDList(page: currentPage - 1) : null,
//         ),
//         for (int i = startPage; i <= endPage; i++)
//           Padding(
//             padding: EdgeInsets.symmetric(horizontal: 2.0),
//             child: ElevatedButton(
//               onPressed: () => getX.fetchNCDList(page: i),
...
//           onPressed: currentPage < totalPages ? () => getX.fetchNCDList(page: currentPage + 1) : null,
//         ),
//       ],
//     );
//   });
