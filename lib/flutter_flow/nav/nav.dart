...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: PlaygroundWidget.routeName,
          path: PlaygroundWidget.routePath,
          builder: (context, params) => PlaygroundWidget(),
        ),
        FFRoute(
          name: DashboardOverviewWidget.routeName,
          path: DashboardOverviewWidget.routePath,
          builder: (context, params) => DashboardOverviewWidget(),
        ),
        FFRoute(
          name: HighBloodPressureWidget.routeName,
          path: HighBloodPressureWidget.routePath,
          builder: (context, params) => HighBloodPressureWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: HeartDiseaseWidget.routeName,
          path: HeartDiseaseWidget.routePath,
          builder: (context, params) => HeartDiseaseWidget(),
        ),
        FFRoute(
          name: ChronicKidneyDiseaseWidget.routeName,
          path: ChronicKidneyDiseaseWidget.routePath,
          builder: (context, params) => ChronicKidneyDiseaseWidget(),
        ),
        FFRoute(
          name: StrokeWidget.routeName,
          path: StrokeWidget.routePath,
          builder: (context, params) => StrokeWidget(),
        ),
        FFRoute(
          name: COPDWidget.routeName,
          path: COPDWidget.routePath,
          builder: (context, params) => COPDWidget(),
        ),
        FFRoute(
          name: HyperlipidemiaWidget.routeName,
          path: HyperlipidemiaWidget.routePath,
          builder: (context, params) => HyperlipidemiaWidget(),
        ),
        FFRoute(
          name: ObesityWidget.routeName,
          path: ObesityWidget.routePath,
          builder: (context, params) => ObesityWidget(),
        ),
        FFRoute(
          name: E_CigaretteUseWidget.routeName,
          path: E_CigaretteUseWidget.routePath,
          builder: (context, params) => E_CigaretteUseWidget(),
        ),
        // FFRoute(
        //   name: LoginWidget.routeName,
        //   path: LoginWidget.routePath,
        ...
        // ),
        FFRoute(
          name: PatientNCDWidget.routeName,
          path: PatientNCDWidget.routePath,
          builder: (context, params) => const PatientNCDWidget(),
        ),
        FFRoute(
          ...
          builder: (context, _) {
            ...
            return SelectHospitalWidget(); // ✅ ไม่ใส่ const
          },
        ),
