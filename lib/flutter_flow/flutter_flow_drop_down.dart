...
class FlutterFlowDropDown<T> extends StatefulWidget {
  const FlutterFlowDropDown({
    ...
    this.labelText,
    this.labelTextStyle,
    this.optionsHasValueKeys = false, required double dropdownHeight,
  }) : assert(
...
class _FlutterFlowDropDownState<T> extends State<FlutterFlowDropDown<T>> {
  ...
  Widget _buildDropdown() {
    final overlayColor = WidgetStateProperty.resolveWith<Color?>((states) => states.contains(WidgetState.focused) ? Colors.transparent : null);
